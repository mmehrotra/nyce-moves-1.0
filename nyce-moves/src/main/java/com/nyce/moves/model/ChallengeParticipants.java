...
public class ChallengeParticipants {
	...
	@JsonProperty("challengePariticipantId")
	private Long challengePariticipantId = null;
	...
	public ChallengeParticipants playerId(Long playerId) {
	...
	public ChallengeParticipants name(String name) {
		this.name = name;
		return this;
	}
	...
	public ChallengeParticipants displayImageUrl(String displayImageUrl) {
	...
	public ChallengeParticipants displayImagePreSignedUrl(String displayImagePreSignedUrl) {
	...
	public boolean equals(java.lang.Object o) {
		...
		ChallengeParticipants friend = (ChallengeParticipants) o;
		return Objects.equals(this.playerId, friend.playerId) && Objects.equals(this.name, friend.name) && Objects.equals(this.displayImageUrl, friend.displayImageUrl) && Objects.equals(this.displayImagePreSignedUrl, friend.displayImagePreSignedUrl);
	}
